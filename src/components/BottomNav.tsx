...
function HomeIcon({ className }: { className?: string }) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="22" height="22" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" className={className}>
...
function UtangIcon({ className }: { className?: string }) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="22" height="22" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" className={className}>
      <path d="M14.4862 22H13.0005V20.5142C13.0005 20.0427 13.1878 19.5905 13.5211 19.2571L18.388 14.3905C18.9087 13.8698 19.7528 13.8698 20.2734 14.3905L20.61 14.7271C21.1306 15.2478 21.1306 16.092 20.61 16.6127L15.7431 21.4793C15.4098 21.8127 14.9576 22 14.4862 22Z" />
      <path d="M19.0005 10V9C19.0005 5.70017 19.0005 4.05025 17.9754 3.02513C16.9502 2 15.3003 2 12.0005 2H10.0005C6.70066 2 5.05074 2 4.02561 3.02513C3.00049 4.05025 3.00049 5.70017 3.00049 9V16C3.00049 18.3389 3.00049 19.5083 3.53695 20.3621C3.8167 20.8073 4.19316 21.1838 4.63838 21.4635C5.49216 22 6.6616 22 9.00049 22" />
      <path d="M11.0005 6H15.0005" />
      <path d="M7.00049 10H15.0005" />
      <path d="M7.00049 14H13.0005" />
    </svg>
  )
}
...
export default function BottomNav({ current, onNavigate }: Props) {
  const navItems = [
    ...
    { page: 'utang' as Page, icon: UtangIcon, label: 'Utang' },
    { page: 'inventory' as Page, icon: InventoryIcon, label: 'Imbentaryo' },
    { page: 'reports' as Page, icon: UlatIcon, label: 'Ulat' },
      ...
      {navItems.map(({ page, icon: Icon, label }) => (
        ...
        >
          ...
          <span className={`text-[9px] font-bold uppercase tracking-wider ${
            current === page ? 'text-[#0D3B2E]' : 'text-gray-300'
          }`}>
            {label}
          </span>
          {current === page && (
